...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5995093361:AAHtZJRgUJQeu6V0fvbfY4I_HSRyk0objbQ"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Nischsy AI Bot'
username = 'AI_Chat_Gpt_robot'
